...
export class Building {
  ...
  assignConstructionToSpace(space, floorKey, template) {
    // Floor construction
    if (floorKey === 'ground') {
      space.floorConstruction = template.construction.floor.ground;
    } else {
      space.floorConstruction = template.construction.floor.upper;
    }
    ...
    if (isTopFloor) {
      space.ceilingConstruction = template.construction.roof;
    } else {
      space.ceilingConstruction = template.construction.floor.upper;
    }
    
    // Wall construction (default to internal, will be refined by adjacency)
    space.wallConstruction = {
      north: template.construction.walls.internal,
      south: template.construction.walls.internal,
      east: template.construction.walls.internal,
      west: template.construction.walls.internal
    };
    
    // Window characteristics
    space.windowCharacteristics = template.construction.windows;
  }
